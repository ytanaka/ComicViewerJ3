    ...
    <Dialog open={showBookmarkManager} onOpenChange={b => setVolatileField('showBookmarkManager', b)}>
      <DialogContent className="w-[90vw]! max-w-[90vw]! h-[90vh] max-h-none flex flex-col overflow-hidden">
        ...
        <div className="flex flex-col">
          <div className="flex">
            <Button variant='secondary' onClick={bookmarkCommands.add} title="ALT+A" >追加<span className="font-thin">(A)</span></Button>
          ...
          <div className="flex">
            <Button variant='secondary' onClick={() => bookmarkCommands.moveFocusUpDown(-1)} title='ALT+↑' >上へ移動<span className="font-thin">(↑)</span></Button>
            <Button variant='secondary' onClick={() => bookmarkCommands.moveFocusUpDown(1)} title='ALT+↓'>下へ移動<span className="font-thin">(↓)</span></Button>
            <Button variant='secondary' onClick={bookmarkCommands.remove} title='ALT+D' >削除<span className="font-thin">(D)</span></Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
